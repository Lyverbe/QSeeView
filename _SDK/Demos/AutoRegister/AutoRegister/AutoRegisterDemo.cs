        ...
        private void DeviceLogin()
        {
            while (true)
            {
                ...
                if (res)
                {
                    ...
                    IntPtr loginID = NETClient.LoginWithHighLevelSecurity(item.IP, item.Port, item.UserName, item.Password, EM_LOGIN_SPAC_CAP_TYPE.SERVER_CONN, pParam, ref device);
